...
namespace V8Net.Infra.CrossCutting.AspNetFilters
{
    public class GlobalExceptionHandlingFilter : IExceptionFilter
    {
        ...
        public void OnException(ExceptionContext context)
        {
            ...
            // Habilitado para 'true' para não consumir recursos do servidor, pois, 
            // qualquer disparo de exception, o servidor ficará observando.
