...
{
    public class AtualizarEmpresaCommand : Notifiable, ICommand
    {
        ...
        public bool IsValidCommand()
        {
            AddNotifications(new ValidationContract()
                ...
                .HasMaxLen(Telefone, 8, "Telefone", "O campo telefone deve conter no máximo 8 caracteres")
                .HasMinLen(Telefone, 8, "Telefone", "O campo telefone deve conter no mínimo 8 caracteres")
